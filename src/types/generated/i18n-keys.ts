...
export const translationKeys = [
  ...
  'connections.components.route.title',
  'connections.components.route.app',
  'connections.components.route.inbound',
  'connections.components.route.rule',
  'connections.components.route.policy',
  'connections.components.route.exit',
  'connections.components.route.remote',
  'connections.components.route.details',
  ...
  'layout.components.navigation.groups.proxies',
  ...
  'profiles.page.sections.extensions',
  ...
  'profiles.page.feedback.errors.confConversionFailed',
  ...
  'profiles.components.menu.convertToConf',
  'profiles.components.menu.reconvertToConf',
  ...
  'profiles.components.menu.revealInFinder',
  ...
  'profiles.modals.confirmConfOverwrite.title',
  'profiles.modals.confirmConfOverwrite.message',
  'profiles.modals.confirmConfOverwrite.confirm',
  ...
  'proxies.page.actions.addProxy',
  'proxies.page.actions.addGroup',
  ...
  'proxies.page.labels.outboundMode',
  'proxies.page.labels.readonlyGroup',
  ...
  'proxies.page.placeholders.searchNodes',
  ...
  'proxies.page.messages.noNodes',
  'proxies.page.messages.noGroups',
  'proxies.page.modeDescriptions.rule',
  'proxies.page.modeDescriptions.global',
  'proxies.page.modeDescriptions.direct',
  'proxies.page.sections.proxy',
  'proxies.page.sections.policyGroup',
  'proxies.page.title.default',
  'proxies.page.title.chainMode',
  'proxies.page.menus.editProxy',
  'proxies.page.menus.editGroup',
  'proxies.page.menus.duplicate',
  'proxies.page.menus.deleteProxy',
  'proxies.page.menus.deleteGroup',
  'proxies.page.menus.testLatency',
  'proxies.page.menus.benchmark',
  ...
  'proxies.feedback.editor.invalidYaml',
  'proxies.feedback.editor.missingName',
  'proxies.feedback.editor.duplicateName',
  'proxies.feedback.editor.notFound',
  'proxies.feedback.editor.emptyGroup',
  'proxies.feedback.editor.saveRejected',
  ...
  'rules.page.provider.detail.open',
  'rules.page.provider.detail.back',
  'rules.page.provider.detail.searchPlaceholder',
  'rules.page.provider.detail.empty',
  'rules.page.provider.detail.loadFailed',
  'rules.page.provider.detail.unavailable.mrs',
  'rules.page.provider.detail.unavailable.cachePathUnavailable',
  'rules.page.provider.detail.unavailable.cacheMissing',
  'rules.page.actions.add.trigger',
  'rules.page.actions.add.title',
  'rules.page.actions.add.confirm',
  'rules.page.actions.add.position.label',
  'rules.page.actions.add.position.prepend',
  'rules.page.actions.add.position.append',
  'rules.page.actions.add.validation.duplicateRule',
  'rules.page.actions.delete.trigger',
  'rules.page.actions.delete.selectFirst',
  'rules.page.actions.delete.title',
  'rules.page.actions.delete.description',
  'rules.page.actions.delete.confirm',
  'rules.page.actions.edit.title',
  'rules.page.actions.edit.hint',
  'rules.page.actions.toggle.enable',
  'rules.page.actions.toggle.disable',
  'rules.page.actions.scrollTop',
  'rules.page.columns.id',
  'rules.page.columns.type',
  'rules.page.columns.value',
  'rules.page.columns.policy',
  'rules.page.columns.used',
  'rules.page.columns.enabled',
  'rules.page.description',
  'rules.page.searchPlaceholder',
  'rules.page.title',
  ...
  'rules.feedback.notifications.runtimeReadFailed',
  'rules.feedback.notifications.saveFailed',
  'rules.feedback.notifications.mutationNotApplied',
  'rules.feedback.notifications.addSuccess',
  'rules.feedback.notifications.deleteSuccess',
  'rules.feedback.notifications.editSuccess',
  'rules.feedback.notifications.editUnavailable',
  'rules.feedback.notifications.editAmbiguous',
  'rules.feedback.notifications.editTargetChanged',
  'rules.feedback.notifications.disableSuccess',
  'rules.feedback.notifications.enableSuccess',
  'rules.feedback.notifications.toggleAmbiguous',
  ...
  'settings.sections.clash.form.fields.quicFallbackReject',
  ...
  'settings.components.verge.advanced.fields.cliInstallDir',
